...
namespace MyStagePass.Services.Database.Seed
{
	public static class PerformerData
	{
		...
		{
			entity.HasData(
				new Performer { PerformerID = 1, ArtistName = "Dzejla Ramovic", Bio = "Pop singer from BiH", IsApproved = false, UserID = 2 },
				new Performer { PerformerID = 2, ArtistName = "Ilma Karahmet", Bio = "Rising pop artist", IsApproved = true, UserID = 3 },
				new Performer { PerformerID = 3, ArtistName = "Jelena Rozga", Bio = "Famous Croatian pop singer", IsApproved = false, UserID = 4 },
				...
				new Performer { PerformerID = 10, ArtistName = "Emina Jahovic", Bio = "Pop singer from Serbia", IsApproved = null, UserID = 17 }
			);
		}
	}
}