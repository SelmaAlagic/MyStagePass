      ...
      builder: (_) {
        return StatefulBuilder(
          builder: (context, setModalState) {
            final totalPrice = getPrice() * numberOfTickets;
            return Dialog(
              shape: RoundedRectangleBorder(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        _ticketTypeButton(
                          ...
                          onTap: () =>
                              setModalState(() => selectedTicketType = 1),
                        ),
                        ...
                        _ticketTypeButton(
                          ...
                          selected: selectedTicketType,
                          onTap: () =>
                              setModalState(() => selectedTicketType = 2),
                        ),
                        const SizedBox(width: 6),
                        _ticketTypeButton(
                          label: "Premium",
                          price: event.premiumPrice,
                          value: 3,
                          selected: selectedTicketType,
                          onTap: () =>
                              setModalState(() => selectedTicketType = 3),
                        ),
                      ],
                    ),
                    const SizedBox(height: 16),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: const Color(0xFF1D235D).withOpacity(0.06),
